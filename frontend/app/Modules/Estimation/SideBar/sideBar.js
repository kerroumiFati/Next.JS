...
import { FaUser , MDBIcon} from 'react-icons/fa';
...
>
    <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M5 21v-4m0 0V5m0 4h14M19 19H5"
    />
</svg>
                        ...
                        <div className="mb-4">
                            ...
                            <ul className="pl-4">
                                ...
                                <li className="mb-2">
                                    <Link href="/Modules/Estimation/Enregistrement/Sortie" className="text-gray-800 hover:text-blue-300 transition duration-300 ease-in-out">
                                        2-  Sortie
                                    </Link>
                                </li>
                                <li className="mb-2">
                                    <Link href="/Modules/Estimation/Enregistrement/Ouverture" className="text-gray-800 hover:text-blue-300 transition duration-300 ease-in-out">
                                        3-  ouverture
                                    </Link>
                                </li>
